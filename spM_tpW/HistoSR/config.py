...
class config:
    ...
    resume_model = '../PW/logs/2_17_17_6/models/best_agent2.pth' # this is the pretrained model of PW
    ...
    episode_len_patch = 6 # default : 6 ; T1
    gamma = 0.5 # default: 1
    ...
    use_discrminator = False # default : False
